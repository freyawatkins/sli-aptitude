...
( nback_comb_mdl <- lm(nback_comb ~ session + self_rating, 
                  data = apt) ) 

summary(nback_comb_mdl)

( nback_lett_mdl <- lm(nback_lett ~ session + self_rating, 
                  data = apt) ) 

summary(nback_lett_mdl)

( nback_spat_mdl <- lm(nback_spat ~ session + self_rating, 
                  data = apt) ) 
...
( corsi_corr_mdl <- lm(corsi_corr ~ session + self_rating, 
                  data = apt) ) 
...
( kirk_mdl <- lm(kirk_acc ~ session + self_rating, 
                 data = apt) ) 
...
( kbit_mdl <- lm(kbit_acc ~ session + self_rating, 
                  data = apt) ) 
...
( dspan_corr_mdl <- lm(dspan_corr ~ session + self_rating, 
                  data = apt) ) 

summary(dspan_corr_mdl)

( dspan_mem_mdl <- lm(dspan_mem ~ session + self_rating, 
                  data = apt) ) 
...
( mr2d_sats_mdl <- lm(mr2d_sats ~ session + self_rating, 
                  data = apt) ) 

summary(mr2d_sats_mdl)

( mr2d_rt_mdl <- lm(mr2d_rt ~ session + self_rating, 
                  data = apt) ) 
...
( mr2d_rt_mdl2 <- lm(mr2d_rt ~ session + self_rating, 
                  data = apt2) ) 
...
( mr3d_sats_mdl <- lm(mr3d_sats ~ session + self_rating, 
                  data = apt) ) 

summary(mr3d_sats_mdl)

( mr3d_acc_mdl <- lm(mr3d_acc ~ session + self_rating, 
                  data = apt) ) 

summary(mr3d_acc_mdl)

( mr3d_rt_mdl <- lm(mr3d_rt ~ session + self_rating, 
                  data = apt) ) 
...
( bis_mdl <- lm(bis_tot ~ session + self_rating, 
                  data = apt) ) 
