...
```{r}
apt <- apt %>% filter(selection != "rejected")
```
...
corsi2_srt3 <- lm(`bsl_srt_3rd year` ~ `corsi_corr_2nd year`,
                  data = apt_wide)
summary(corsi2_srt3)
...
mr3d0_bsl1 <- lm(`grade_bsl_1st year` ~ `mr3d_sats_pre-degree`, data = apt_wide)
summary(mr3d0_bsl1)
...
mlat_bsl_1 <- lm(`grade_bsl_1st year` ~ `mlat_acc_pre-degree`, data = apt_wide)
summary(mlat_bsl_1)
...
mlat_bsl_2 <- lm(`grade_bsl_2nd year` ~ `mlat_acc_pre-degree`, data = apt_wide)
summary(mlat_bsl_2)
```
