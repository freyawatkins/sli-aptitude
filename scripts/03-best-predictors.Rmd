...
mr2d2_mr3d2 <- lm(`mr2d_sats_2nd year` ~ `mr3d_sats_2nd year` +
                   self_rating, data = apt_wide)
summary(mr2d2_mr3d2)
...
mr2d3_mr3d3 <- lm(`mr3d_sats_3rd year` ~ `mr2d_sats_3rd year` +
                   self_rating, data = apt_wide)
summary(mr2d3_mr3d3) # significantly predict each other
```
